          ...
          <div className="col-12 col-md-8 col-lg-6 col-xl-5">
            <div className="card bg-dark text-white" style={{ borderRadius: '1rem' }}>
              <div className="card-body p-5 text-center">
                ...
                <div>
                  <p className="mb-0">Don't have an account? <Link to='/register' className="text-white-50 fw-bold">Sign Up</Link> Else <Link to='/' className="text-white-50 fw-bold">Back to Home</Link> </p>
                </div>
              </div>
            </div>
          </div>
